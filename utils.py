...
def parse_command():
    model_names = ['resnet18', 'resnet50','mobilenet','mobilenetskipadd','mobilenetskipconcat']
    loss_names = ['l1', 'l2']
    data_names = ['nyudepthv2', 'kitti', 'custom']
    ...
    parser.add_argument('--decoder', '-d', metavar='DECODER', default='nnconv9dw', choices=decoder_names,
    ...
    parser.add_argument('-b', '--batch-size', default=1, type=int, help='mini-batch size (default: 8)')
